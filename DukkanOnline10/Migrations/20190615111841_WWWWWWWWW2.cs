...
{
    public partial class WWWWWWWWW2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DukkanAdi = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Dukkan_DukkanId",
                        column: x => x.DukkanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Envanter", x => x.EnvanterID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sepet", x => new { x.EnvanterID, x.SiparisID });
                    table.ForeignKey(
                        name: "FK_Sepet_Envanter_EnvanterID",
